...
export const NewsLetter = () => {
    return (
        <div className="bg-primary w-full h-[398px] lg:h-[306px] text-white">
            <div className="max-w-[1500px] mx-auto flex flex-col lg:flex-row justify-center gap-[20px] lg:justify-evenly items-center h-full px-[16px]">
                ...
                <div className="bg-[#C9DCEC] h-[54px] w-full lg:w-[445px] lg:flex flex-col lg:flex-row gap-y-[10px] rounded-[6px]">
                    ...
                    <button className="bg-white px-[46px] py-[11px] text-black font-manrope text-[16px] tracking-[-1.5%] rounded-tr-[6px] rounded-br-[6px] w-full lg:w-auto mt-[10px] lg:mt-0 rounded-tl-[6px] lg:rounded-tl-[0px] rounded-bl-[6px] lg:rounded-bl-[0px] hover:bg-[#f2f0f0] duration-300">
                        Send
                    </button>
                </div>
            </div>
